			...
			success:function(data){
				...
				for (var i=0;i<data.length;i++) {
					...
					<div class="col-xs-6 detail">
						<h5 name="`+data[i].goodsID+`">`+data[i].goodsName+`</h5>
...
window.onload=function(){
    ...
    num_jia.onclick = function() {
            ...
            $.ajax({
            	...
            	success:function(data){console.log(data);if(parseInt(input_num.value)==0){window.location.href='cart.html';}}
            });
        }
    ...
    $('.delete').click(function(){
        	$.ajax({
            	...
            	success:function(data){console.log(data);window.location.href='cart.html';}
            	});
